...
> ### Example:  
> If the average ingest rate is 100x 2 KiB logs per second, a single standard plan instance can sustain storage for approximately 7 to 34 days, depending on the specific scaling configuration.
...
> ### Example:  
> If the average ingest rate is 1000x 2 KiB logs per second, a single large plan instance can sustain storage for approximately 7 to 34 days, depending on the specific scaling configuration.
